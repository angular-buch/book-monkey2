...
@Component({
  template: `
    <div class="ui three small ordered steps">
      <a [routerLink]="['book-list']" routerLinkActive="active"
         class="step">
        <div class="content">
          <div class="title">Listenansicht</div>
        </div>
      </a>
      <a [routerLink]="['book-list-refactored']" routerLinkActive="active"
         class="step">
        <div class="content">
          <div class="title">Verbesserte Listenansicht</div>
        </div>
      </a>
      <a [routerLink]="['book-details']" routerLinkActive="active"
         class="step">
        <div class="content">
